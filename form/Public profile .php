...
$name = $public_email = $url = $bio = $twitter_username = $linkedIn_username = $facebook_username = $department = $location = $submited = $fileToUpload = "";
...
function test_input($data) {
  ...
  VALUES ('$name' , '$public_email' , '$url' , '$bio' , '$twitter_username' , '$linkedIn_username' ,'$facebook_username' , '$department' , '$location' , '$fileToUpload')";
